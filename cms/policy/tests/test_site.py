#-*- coding: UTF-8  -*-
import unittest
from cms.policy.testing import INTEGRATION_TESTING
...
class TestSetup(unittest.TestCase):
    ...
    def test_portal_title(self):
        ...
        self.assertEqual("CMS", portal.getProperty('title'))
    
    def test_portal_description(self):
        portal = self.layer['portal']
        self.assertEqual(u"中医科学AI系统", portal.getProperty('description'))
    ...
    def test_Requirements_installed(self):
        ...
        self.assertTrue('cms.db.folder' in portal_types)
